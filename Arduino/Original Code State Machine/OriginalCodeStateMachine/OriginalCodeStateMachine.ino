// ME350 Ball Handling Sketch - Version 04
// updated 11-28-2016
//
...
const int CHUTE_2_POSITION    = 0;                // [encoder counts] Motor position corresponding to second chute
const int PUT_POSITION        = 0;                // [encoder counts] Motor position corresponding to basket lane
...
// Timing:
const long  WAIT_TIME         = 0; // [microseconds] Time waiting for the ball to drop.
// VARIABLES:
...
void loop() {
  ...
  switch (state) {
    ...
    //****************************************************************************//
    // In the WAIT state, we move the cup to a neutral position (close to the 
    ...
    //****************************************************************************//
    // In this state, we stay at the chute and wait until the ball was dropped:
    case WAIT_FOR_BALL:
